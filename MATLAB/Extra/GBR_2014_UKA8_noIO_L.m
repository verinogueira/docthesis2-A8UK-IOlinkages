%% MODEL WITHOUT IO
%counterfactual to low-skilled A8 below
...
filename = 'Counterfactuals_UKA8L_noIO.xls';

CF = table(industry,alphai,deltai,l_shares,mu,beta,ki_cf,li_cf,hi_cf,p_cf,q_cf,y_cf,dqidH_cf);
...
% % % aggregate effect % % %
filename = 'Aggregate_Effect_UKA8_LnoIO.xls';
    LnoIO = table(industry,q_obs,q_cf);
        writetable(LnoIO,filename,'Sheet',1,'Range','B2')