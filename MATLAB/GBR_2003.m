...
% constructs the parameters for robustness test
...
%low skill
l_shr = readmatrix('Data_GBR_2003.xls','Sheet','pri_qua','Range','B2:B30');
l_obs = l_shr.*e_obs;
%high skill
h_shr = readmatrix('Data_GBR_2003.xls','Sheet','pri_qua','Range','C2:C30');
h_obs = h_shr.*e_obs;
...
PAY_K = 648438.735473633; % sum of column G
PAY_L = 660365.523692328; % sum of column I times cell A2 sheet 'LH_shares'
PAY_H = 518517.826161188; % sum of column I times cell B2 sheet 'LH_shares'
...
pd_obs = readmatrix('Data_GBR_2003.xls','Sheet','IO','Range','B2:AD30');
...
% PRICES
p_data = readmatrix('Data_GBR_2003.xls','Sheet','pri_qua','Range','E2:E30');
...
% save data file
save('PAR2003.mat','Gamma','beta','mu','alpha','delta','alphai','deltai','gammai','A')
...
title('IO Matrix \Gamma (UKA8 2003)','FontSize',14);
xlabel('Buying industries','fontsize',14), ylabel('Selling industries','fontsize',14);
